...
Public Class PROFESSOR_DASHBOARD
    ...
    Private Sub btnprofback_Click(sender As Object, e As EventArgs) Handles btnprofback.Click
        PROF_LOGIN.Show() ' Show the login form
    ...
    Private Sub btnprofclear_Click(sender As Object, e As EventArgs) Handles btnprofclear.Click
        ' Clear only TextBoxes and ComboBoxes
        ...
        ' Focus back to first input field (optional)
        txtstudid.Focus()
    End Sub
